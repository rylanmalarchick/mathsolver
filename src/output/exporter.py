...
class SolutionExporter:
    ...
    def __init__(self, solution: Solution, options: ExportOptions | None = None):
        """
    ...
    def to_python(self, output_path: str | None = None) -> str:
        """
        ...
        lines = [
            '"""',
            "Solution generated by MathSolver",
        ]
        ...
        if self.solution.symbolic_result is not None and hasattr(
            self.solution.symbolic_result, "free_symbols"
        ):
    ...
    def to_latex(self, output_path: str | None = None) -> str:
        """
    ...
    def to_text(self, output_path: str | None = None) -> str:
        """
